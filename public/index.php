    ...
    <body>
        <div class="container pb-5">
            <div class="row mt-2 mb-3">
                ...
                <div class="col-md-5 text-center pt-1 position-relative sticky-md-top">
                    <a name="affiche"></a>
                    <div id="image_loader" class="spinner-border text-dark position-absolute start-50" style="position: absolute; z-index: 9999; top: 30px;" role="status">
                ...
                <form action="camera.php" method="GET">
                    ...
                    <div class="d-md-none row">
                        <div class="d-grid gap-2 col-6">
                            <a href="#affiche" class="btn btn-outline-secondary"><small id="btn_image_loader" class="spinner-border spinner-border-sm invisible float-end" role="status" aria-hidden="true"></small>Voir l'affiche</a>
                        </div>
                        <div class="d-grid gap-2 col-6">
                            <button class="btn btn-primary" type="submit">Continuer</button>
                        </div>
        ...
        <script type="text/javascript">
            ...
            document.querySelector('#btn_csv_edit').addEventListener('click', function() {
                ...
                updateAffiche();
                if(csv) {
                    document.querySelector('#input_csv') = csv;
                }
            })
